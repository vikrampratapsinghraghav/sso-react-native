...
export default function App() {
  ...
  const callOBO = async () => {
    try {
      const TENANT_ID = process.env.TENANT_ID || "6171e1a1-b822-451c-b9bb-e6e35d88b0db";
      const CLIENT_ID = process.env.INCEPTION_CLIENT_ID || "2a32a3c0-44db-4b75-9c12-aeb655812975";
      const CLIENT_SECRET = process.env.INCEPTION_CLIENT_SECRET || "PLACEHOLDER_SECRET";
      ...
      const params = new URLSearchParams({
        ...
        assertion: user?.accessToken, // 🔹 user token from frontend
        requested_token_use: "on_behalf_of",
        scope: "api://2a32a3c0-44db-4b75-9c12-aeb655812975/inalphademo"
      });
  ...
  const signIn = async () => {
    ...
    try {
      const result = await pca.acquireToken({
        scopes: [
          "api://2a32a3c0-44db-4b75-9c12-aeb655812975/inalphademo"
        ],
        prompt: "consent"
      });
